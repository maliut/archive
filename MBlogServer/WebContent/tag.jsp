...
TagModel tag = (TagModel) request.getAttribute("tag"); 
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title><%=tag.getName() %>&nbsp;-&nbsp;<%=targetUser.getBlogName() %></title>
...
<body>
	...
	<div id="main-wrapper">
		<p class="entry-prompt">查看<%=tag.getName() %>下的所有文章</p>
		<% 
		...
		<% } else { 
		 	for (int i = 0; i < posts.size(); i++) {  
		 		CategoryModel category = CategoryModel.getCategoryFromCID(posts.get(i).getCategoryID()); %>
