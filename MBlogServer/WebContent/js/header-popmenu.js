...
function search() {
	...
	window.location.href = "search?keyword=" + keyword + "&range=0&username=&place=title&sort_by=time&sort=d";
}
...
document.getElementById("searchBar").onkeydown = keyDownToSearch;
