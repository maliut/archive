...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { department_id: @manager.department_id, email: @manager.email, gender: @manager.gender, location: @manager.location, name: @manager.name, tel: @manager.tel, user_id: @manager.user_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { department_id: @manager.department_id, email: @manager.email, gender: @manager.gender, location: @manager.location, name: @manager.name, tel: @manager.tel, user_id: @manager.user_id } }
