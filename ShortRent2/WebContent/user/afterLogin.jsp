<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <li class="menu-level-0"><a href="../userAction!toHouseAdmin.action?u.id=<s:property value="#session.user.id"/>&page=1"><span>控制面板</span></a></li>
    ...
    <li class="menu-level-0"><a onclick="out()"><span>登出</span></a></li>
    <li class="menu-search">
    <form id="searchForm" class="menu-search-form" method="post">
    <input type="text" name="search" value="" class="menu-search-field" placeholder="去哪儿" />
