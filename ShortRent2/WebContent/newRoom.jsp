...
<body>
	<div class="body_wrap">
		<div class="container">
			...
			<form id="newRoomForm" action="newHouse" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-sm-4 ">
					...
					<div class="col-sm-4">
						...
						<div class="field_select">
							...
							<div class="field_select">
								全额退款日 <select class="select_styled" name="ho.refundDay" id="refundDay">
									<option value="1">1</option>
									<option value="2">2</option>
									<option value="3">3</option>
									<option value="4">4</option>
					...
					<div class="col-sm-4 ">
						<div class="form-wrapper">
							...
							<div class="row button-area boxed-turquoise">
								...
								<a href="javascript:;" id="verify" onclick="document.getElementById('ver-pic').src = 'verification.action?time='+Math.random();"> 
								<img id="ver-pic" width="100px" height="40px" src="verification.action" alt="验证码挂了" /> </a><br>
